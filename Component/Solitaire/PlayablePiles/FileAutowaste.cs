...
namespace PlayingCards.Component.Solitaire
{
	...
	class FileAutowaste : File
	{
        ...
        {
            AddRecord(typeof(FileAutowaste), "InitialCount", "PileBuildStrategy", "InitialShown", "AssociationTokens", "AutoMoveThreshold");
        }
		...
		/// <inheritdoc cref="File.GetProperties"/>
		public override PileProperty GetProperties()
		{
			...
			property.AutoMoveThreshold = m_automoveThreshold;
			return property;
		}

		/// <inheritdoc cref="File.SetProperties"/>
		...
		/// <inheritdoc cref="File.Duplicate"/>
		public override SolitairePile Duplicate()
		{
			var a = GetProperties();
			return new FileAutowaste(GameContext, a);
		}
		//======================================================================//
		#endregion
