...
namespace PlayingCards.Component.Solitaire
{
    ...
    public class File : SolitairePile
    {
		...
		public override PileProperty GetProperties()
		{
			...
			property.InitialShown = m_initialShown;
			return property;
		}
        ...
        {
			m_initialShown = properties.InitialShown ?? (int)PileProperty.GetDefaultNoneNullValue("InitialShown");
			m_partitionIndex = InitialCount - m_initialShown;
